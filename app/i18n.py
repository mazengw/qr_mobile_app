...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "your_vaults": {
        "en": "Long-press an item to reorder",
        "ar": "اضغط مطولاً على عنصر لإعادة الترتيب",
    },
    "scan_qr": {"en": "Scan QR", "ar": "مسح QR"},
    "refresh": {"en": "Refresh", "ar": "تحديث"},
    "home_refreshed": {"en": "List updated", "ar": "تم تحديث القائمة"},
    "home_refreshing": {"en": "Refreshing…", "ar": "جارٍ التحديث…"},
    ...
    "qr_hint": {"en": "e.g. 1 · share:<uuid> · join:<uuid>", "ar": "مثال: 1 أو share:<uuid> أو join:<uuid>"},
    ...
    "join_qr_title": {"en": "Join via QR", "ar": "الانضمام عبر QR"},
    "join_qr_hint": {
        "en": "Anyone signed in who scans this QR joins the storage immediately.",
        "ar": "أي مستخدم مسجّل يمسح هذا الرمز ينضم للخزنة فوراً.",
    },
    "join_qr_generate": {"en": "Show join QR", "ar": "عرض رمز الانضمام"},
    "join_qr_regenerate": {"en": "New QR", "ar": "رمز جديد"},
    "join_qr_deactivate": {"en": "Disable QR", "ar": "تعطيل الرمز"},
    "join_qr_inactive": {"en": "Join QR is disabled", "ar": "رمز الانضمام معطّل"},
    "join_qr_created": {"en": "Join QR ready", "ar": "رمز الانضمام جاهز"},
    ...
    "restaurant_name": {"en": "Business name", "ar": "اسم النشاط"},
    "menu_description": {"en": "Description", "ar": "الوصف"},
    "business_style": {"en": "Business type / icons", "ar": "نوع النشاط / الرموز"},
    "business_style_tip": {
        "en": "Changes placeholder icons (cover, logo, products) to match your business. Photos you upload stay as-is.",
        "ar": "يغيّر الرموز الافتراضية (الغلاف والشعار والمنتجات) لتناسب نشاطك. الصور التي ترفعها تبقى كما هي.",
    },
    "business_style_restaurant": {"en": "Restaurant", "ar": "مطعم"},
    "business_style_cafe": {"en": "Cafe", "ar": "مقهى"},
    "business_style_bakery": {"en": "Bakery", "ar": "مخبز"},
    "business_style_grocery": {"en": "Grocery", "ar": "بقالة"},
    "business_style_library": {"en": "Library / Stationery", "ar": "مكتبة / قرطاسية"},
    "business_style_pharmacy": {"en": "Pharmacy", "ar": "صيدلية"},
    "business_style_fashion": {"en": "Fashion", "ar": "أزياء"},
    "business_style_electronics": {"en": "Electronics", "ar": "إلكترونيات"},
    "business_style_beauty": {"en": "Beauty", "ar": "تجميل"},
    "business_style_gym": {"en": "Gym", "ar": "رياضة"},
    "business_style_generic": {"en": "Store / General", "ar": "متجر / عام"},
    ...
    "add_cover_photo": {"en": "Cover photo", "ar": "صورة الغلاف"},
    "add_logo": {"en": "Logo", "ar": "الشعار"},
    "change_photo": {"en": "Change photo", "ar": "تغيير الصورة"},
    ...
    "share_unified_hint": {
        "en": "Choose permission, then invite by phone or show a join QR.",
        "ar": "اختر الصلاحية، ثم ادعُ برقم الهاتف أو اعرض رمز انضمام QR.",
    },
    "share_or": {"en": "or", "ar": "أو"},
