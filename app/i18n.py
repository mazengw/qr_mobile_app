...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "ai_fab_drag_hint": {
        "en": "Move mode: drag anywhere, tap to finish",
        "ar": "وضع التحريك: اسحب في أي مكان ثم اضغط لإنهاء",
    },
    "ai_fab_move_banner": {
        "en": "Drag to move AI button · Tap to finish",
        "ar": "اسحب لتحريك زر الذكاء · اضغط لإنهاء التحريك",
    },
